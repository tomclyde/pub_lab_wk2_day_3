...
class TestPub < Minitest::Test
  ...
  def setup
    ...
    @pub2 = Pub.new("Milnes", 200.50, [@bud, @highland_park],[@pie,@chips,@steak])
  end
  ...
  def test_pub_till_increase__buy_drink
  ...
  def test_pub_till_increase__buy_food
      @cust2.buy_food(@pub2,@chips)
      cust_food_price = @pub2.food[1].return_food_price
      @pub2.pub_till_money_increase(cust_food_price)
      assert_equal(205.00, @pub2.till)
  end
  ...
  def test_pub_stock_value
    assert_equal(2, @pub2.pub_stock_value)
  end
